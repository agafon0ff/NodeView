...
void NodeView::checkRopeCreation(QPointF point)
{
...
void NodeView::checkRopeConnection(QPointF point)
{
    if(!m_activeRope)
        return;
...
NodeItem *NodeView::checkNodeHit(QPointF point)
{
    NodeItem *hitNode = NULL;
...
PortItem *NodeView::checkPortHit(QPointF point)
{
    PortItem *hitPort = NULL;
...
NodeItem *NodeView::nodeAt(QUuid uuid)
{
